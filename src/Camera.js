...
import { FColors, FVertex } from "./tempdata";
...
export default function Camera() {
    ...
    for (var ii = 0; ii < numFs; ++ii) {
        ...
        var x = 10;//Math.cos(angle) * radius;
        var y = 0;//Math.sin(angle) * radius;
        var z = 10;

        drawAtPosition(x, y, x);
    }
    ...
    function setGeometry(context, geometry) {
        ...
        context.bufferData(context.ARRAY_BUFFER, FVertex, context.STATIC_DRAW);
    }
